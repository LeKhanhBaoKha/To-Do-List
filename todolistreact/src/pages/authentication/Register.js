...
const Register = () => {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:8008/api/register", data)
      .then((response) => {
  ...
  return (
    <div className="flex justify-center items-center h-[80vh]">
      <div className="mx-auto rounded-2xl border bg-white p-2 shadow-sm w-[600px]">
        <form
          className="sm:w-[300px] md:w-[400px] lg:w-[500px] bg-white px-8 pt-6 pb-8 m-auto"
          method=""
          action=""
        ...
        >
          ...
          <div className="flex items-center justify-between">
            {name == "" || email == "" || password == "" || repassword == "" ? (
              ...
              <button
                className="bg-purple-500 hover:bg-purple-400 hover:cursor-pointer focus:shadow-outline text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline "
                type="submit"
              >
                Sign up
              </button>

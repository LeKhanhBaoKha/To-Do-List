...
function Create({ data, fetchData }) {
  ...
  function handleCreate(event) {
    ...
    fetch("http://localhost:8008/api/serve/store", dataToSend)
  ...
  return (
    <>
      <div className="z-[1500]">
        ...
        >
          <label
            className="max-h-[calc(100vh - 5em)] scale-99 h-fit max-w-[80%] overflow-auto overscroll-contain rounded-md bg-white p-6 text-black shadow-2xl transition z-[6000]"
            htmlFor=""
          >
            <form
            ...
            >
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="w-4/5">
                  ...
                  >
                    <ProjectsSelect data={data["projects"]} />
                  </select>
                </div>
              </div>
              ...
              >
                ...
                <div className="w-4/5">
                  <select
                    ...
                    id="user_id"
                    onChange={(e) =>
                      setCreateData({ ...createData, user_id: e.target.value })
                    }
                  >
                    <UsersSelect data={data["users"]} />
                  </select>
                </div>
              </div>
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="w-4/5">
                  <input
                    ...
                    placeholder=""
                    onChange={(e) =>
                      setCreateData({ ...createData, deadline: e.target.value })
                    }
                  />
                </div>
              </div>

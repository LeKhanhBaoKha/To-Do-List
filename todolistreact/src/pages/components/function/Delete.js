...
function Delete({ todo, fetchData }) {
  ...
  function deleteTodo(event) {
    ...
    fetch("http://localhost:8008/api/serve/delete", dataToSend)
  ...
  return (
    <>
      <button
        className={[
          [todo["id"], "-delmodal"].join(""),
          "font-bold py-1 px-2 rounded bg-red-500 hover:bg-red-50 hover:text-red-500 text-white transition duration-[0.5s] ease-in-out",
        ].join(" ")}
        id="del-button"
        onClick={(e) => {
          closeDelModal(e);
      ...
      >
        ...
        >
          <FontAwesomeIcon
            ...
            className={[
              [todo["id"], "-delmodal"].join(""),
              "sm:w-[15px] sm:h-[19px] md:w-[20px] md:h-[24px] lg:w-[30px] lg:h-[34px]",
            ].join(" ")}
          />
        </label>
      </button>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-around">
              <button
                type="button"
                className="close-modal bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-4"
              >
                Close
              </button>
              <form method="" action="" onSubmit={(e) => deleteTodo(e)}>
                ...
                ></input>
                <button
                  className="font-bold py-2 px-4 rounded bg-red-500 hover:bg-red-400 text-white"
                  type="submit"
                >
                  <p>Delete</p>
                </button>
